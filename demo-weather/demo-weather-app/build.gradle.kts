...
android {
    namespace = "com.andyha.demoweather"

    defaultConfig {
        applicationId = "com.andyha.demoweather.app"
        versionCode = 1
        versionName = "0.0.1"
    }
    ...
    productFlavors {
        ...
        create("dev") {
            ...
            envConfigProperties.load(File("demo-weather/demo-weather-app/env-config/dev-env-config.properties").reader())
            buildConfigField("String", "weatherBaseUrl", envConfigProperties.getProperty("weatherBaseUrl"))
            buildConfigField("String", "weatherApiKey", envConfigProperties.getProperty("weatherApiKey"))
        }
        create("staging") {
            dimension = "env"
            ...
            envConfigProperties.load(File("demo-weather/demo-weather-app/env-config/staging-env-config.properties").reader())
            buildConfigField("String", "weatherBaseUrl", envConfigProperties.getProperty("weatherBaseUrl"))
            buildConfigField("String", "weatherApiKey", envConfigProperties.getProperty("weatherApiKey"))
        }
        create("production") {
            ...
            envConfigProperties.load(File("demo-weather/demo-weather-app/env-config/production-env-config.properties").reader())
            buildConfigField("String", "weatherBaseUrl", envConfigProperties.getProperty("weatherBaseUrl"))
            buildConfigField("String", "weatherApiKey", envConfigProperties.getProperty("weatherApiKey"))
        }
    }
...
dependencies {
    ...
    implementation(projects.demoWeather.featureWeather)
    implementation(projects.demoWeather.featureLogin)
    implementation(projects.demoWeather.weatherCommon)
    implementation(projects.demoWeather.weatherDomain)
    implementation(projects.demoWeather.weatherData)

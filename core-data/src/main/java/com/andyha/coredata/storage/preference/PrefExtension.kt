...
inline var AppSharedPreference.theme: String?
    get() = this.getString(PreferenceKeys.THEME)
    set(value) = this.set(PreferenceKeys.THEME, value)

inline var AppSharedPreference.language: String?
    get() = this.getString(PreferenceKeys.LANGUAGE)
    set(value) = this.set(PreferenceKeys.LANGUAGE, value)

inline var AppSharedPreference.fontFamily: String?
    get() = this.getString(PreferenceKeys.FONT_FAMILY)
    set(value) = this.set(PreferenceKeys.FONT_FAMILY, value)

inline var AppSharedPreference.fontScale: Float
    get() = this.getFloat(PreferenceKeys.FONT_SCALE)
    set(value) = this.set(PreferenceKeys.FONT_SCALE, value)

inline var AppSharedPreference.materialYou: Boolean
    get() = this.getBoolean(PreferenceKeys.MATERIAL_YOU, false)
    set(value) = this.set(PreferenceKeys.MATERIAL_YOU, value)

inline var AppSharedPreference.primaryColor: String?
    get() = this.getString(PreferenceKeys.PRIMARY_COLOR)
    set(value) = this.set(PreferenceKeys.PRIMARY_COLOR, value)
